  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      const hourlyResponse = await axios.get(
        `https://pro.openweathermap.org/data/2.5/forecast/hourly?lat=${response.data.coord.lat}&lon=${response.data.coord.lon}&appid=b167c88bb7301bc04a99e1bd24f7c97c`
      );
          ...
          <div className="main-container">
            ...
            <div className="tipsBox">
              <p className="warm-up-tips">
                Extend the warm-up session to reduce the risk of muscle
                injuries.
                <br />
                Ensure players are provided with thermal underlayers, gloves,
                hats and shoes designer for the extreme cold
                <br />
            ...
            <div className="precwindDiv">
              ...
              <div className="windBox">
                ...
                <img alt="" src="../assets/images/Compass.svg" />
              </div>
            </div>
          </div>
        </>
